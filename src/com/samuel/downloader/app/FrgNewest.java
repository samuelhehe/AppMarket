...
public class FrgNewest extends Fragment implements OnClickListener,
	...
	public void onResume() {
		...
		super.onResume();
		System.out.println("onResume-----FrgNewest");

		IntentFilter intentFilter = new IntentFilter();
		intentFilter.addAction(ReceiverValue.FrgNewest.ACTION);
	...
	public void onDestroy() {
		// TODO Auto-generated method stub
		super.onDestroy();
		System.out.println("onDestroy===========FrgNewest");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View parentView = inflater.inflate(R.layout.app_themes_newest,
				container, false);

		installedApp_lv = (com.samuel.downloader.view.XListView) parentView
				.findViewById(R.id.app_themes_newest_lv);
	...
	private final class InstalledItemListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if (datas != null && position > 0) {
				...
				intent.setFlags(R.layout.app_themes_newest);
			...
			public void run() {
				try {
					if (type == REFRESH) {
						if (datas != null) {
							datas.clear();
							datas.addAll(HomeItemInfoHandler.getContentsInfo(
									getActivity(), current_page, page_size));
						} else {
							datas = HomeItemInfoHandler.getContentsInfo(
									getActivity(), current_page, page_size);
						}
					...
					// }
					// // List<AppInfo> datas =
					// // HomeItemInfoHandler.getContentsInfo(
					// // getActivity(), 0, 25);
					// if (datas != null && datas.size() > 0) {
					// mHandler.sendMessage(mHandler.obtainMessage(
					// LOAD_COMPLETE, datas));
