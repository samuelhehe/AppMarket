...
public class XListView extends ListView implements OnScrollListener {
	...
	private final static String REFRESH_LAST_TIME = "REFRESH_LAST_TIME";
...
//		System.out.println("current time --->>>"+str);
		PreferencesUtils.getString(getContext(), REFRESH_LAST_TIME);
		mHeaderTimeView.setText(str);
		PreferencesUtils.putString(getContext(), REFRESH_LAST_TIME, str);
